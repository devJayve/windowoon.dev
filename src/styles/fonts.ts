...
export const pretendard = localFont({
  src: [
    {
      path: '../../public/fonts/pretendard/woff2/Pretendard-Thin.woff2',
      weight: '100',
      style: 'normal',
    },
    {
      path: '../../public/fonts/pretendard/woff2/Pretendard-ExtraLight.woff2',
      weight: '200',
      style: 'normal',
    },
    {
    ...
    {
      path: '../../public/fonts/pretendard/woff2/Pretendard-ExtraBold.woff2',
      weight: '800',
      style: 'normal',
    },
    {
